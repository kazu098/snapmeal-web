...
export const enArticles: EnArticle[] = [
  article({
    ...
    intro: 'Cooking becomes easier when you choose one flavor direction before trying to find an exact recipe.',
    angle: 'Reach beginners and efficiency-focused solo cooks who have ingredients but do not know how to season them.',
    decision: 'Start with one flavor base such as soy sauce, miso, mentsuyu, ponzu, consommé, tomato, or curry powder.',
    patterns: [
    ...
    snapmeal: 'Snapmeal can help connect fridge ingredients with realistic seasoning directions and dinner ideas.',
  }),
  article({
    ...
    intro: 'Pasta is useful for solo dinners because it can absorb small leftover ingredients into one plate.',
    angle: 'Target people who want fast, low-cleanup meals without cooking a full family-style dinner.',
    decision: 'Choose a flavor base first, then add one protein and one vegetable from the fridge, freezer, or pantry.',
    patterns: [
    ...
    snapmeal: 'Snapmeal can help turn small fridge leftovers into pasta combinations and flavor ideas.',
  }),
  article({
    ...
    intro: 'Store-bought wrappers and doughs are useful because they give small ingredients a dinner shape.',
    angle: 'Address users who want faster menus from small leftovers, especially solo cooks who do not want multiple dishes.',
    decision: 'Choose whether to wrap, top, or toast the ingredients, then use fast-cooking fillings with low moisture.',
    patterns: [
    ...
    snapmeal: 'Snapmeal can help identify leftover ingredients that can be wrapped, topped, or toasted into a quick dinner.',
  }),
  article({
    ...
    intro: 'Frozen food becomes more satisfying when you treat it as one part of dinner instead of the whole meal.',
    ...
    decision: 'Assign the frozen food a role, then add what is missing: staple, protein, vegetable, or soup.',
    patterns: [
    ...
    snapmeal: 'Snapmeal can help combine frozen foods with fridge ingredients so dinner feels complete with little extra work.',
  }),
  article({
    ...
    intro: 'For solo cooking, the best tool is the one that matches tonight’s energy, cleanup tolerance, and ingredients.',
    angle: 'Use the time-saving tools topic as a practical decision guide rather than a gadget shopping list.',
    decision: 'Use the microwave for reheating and prep, toaster for browning, kettle for hot water, small pot for soups and noodles, and frying pan for searing.',
    patterns: [
    ...
    snapmeal: 'Snapmeal can help choose meal ideas based on both fridge ingredients and the cooking tool you want to use today.',
  }),
  article({
