...
export const enArticles: EnArticle[] = [
  article({
    ...
    title: 'Seasoning Basics for People Who Do Not Know What Flavor to Choose',
    description: 'Learn how soy sauce, miso, mentsuyu, ponzu, consommé, and curry powder help you choose dinner flavors from fridge ingredients.',
    jaHref: '/blog/seasoning-basics-dinner/',
    date: 'May 25, 2026',
    category: 'Cooking Tips',
    image: '/blog/seasoning-basics-dinner-thumbnail-1600x900.jpg',
    tags: ['Seasoning', 'Flavoring', 'Beginner cooking', 'Meal planning'],
    intro: 'Cooking becomes easier when you choose one flavor direction before trying to find an exact recipe, especially when you are cooking from whatever is already in the fridge.',
    angle: 'Reach beginners and efficiency-focused solo cooks who have ingredients but do not know how to season them.',
    decision: 'Start with one flavor base such as soy sauce, miso, mentsuyu, ponzu, consommé, tomato, or curry powder, then adjust saltiness, sweetness, acidity, and aroma separately.',
    patterns: [
    ...
    snapmeal: 'Snapmeal can help connect fridge ingredients with realistic seasoning directions, substitute ideas, and dinner options that match what you actually have.',
  }),
  article({
    slug: 'solo-quick-pasta',
    title: 'Quick Pasta for Solo Living with Leftovers, Cans, and Frozen Vegetables',
    description: 'Solo pasta dinners become faster when you use fridge leftovers, canned foods, eggs, and frozen vegetables instead of building a sauce from scratch.',
    jaHref: '/blog/solo-quick-pasta/',
    date: 'May 25, 2026',
    category: 'Time Saving',
    image: '/blog/solo-quick-pasta-thumbnail-1600x900.jpg',
    tags: ['Solo living', 'Pasta', 'Time saving', 'Canned food'],
    intro: 'Pasta is useful for solo dinners because it can absorb small leftover ingredients into one plate without requiring a full sauce from scratch.',
    angle: 'Target people who want fast, low-cleanup meals without cooking a full family-style dinner.',
    decision: 'Choose a flavor base first, then add one protein and one vegetable from the fridge, freezer, or pantry; keeping a few pantry defaults makes the decision faster.',
    patterns: [
    ...
    snapmeal: 'Snapmeal can help turn small fridge leftovers, canned foods, and frozen vegetables into pasta combinations and flavor ideas.',
  }),
  article({
    slug: 'dough-wrapper-shortcut-dinner',
    title: 'Shortcut Dinners with Store-Bought Wrappers, Tortillas, and Pizza Dough',
    description: 'Gyoza wrappers, tortillas, pizza dough, and bread can turn small leftover ingredients into quick baked or wrapped dinners.',
    jaHref: '/blog/dough-wrapper-shortcut-dinner/',
    date: 'May 25, 2026',
    category: 'Time Saving',
    image: '/blog/dough-wrapper-shortcut-dinner-thumbnail-1600x900.jpg',
    tags: ['Wrappers', 'Tortillas', 'Pizza dough', 'Time saving'],
    intro: 'Store-bought wrappers and doughs are useful because they give small ingredients a dinner shape: wrap, top, toast, and serve.',
    angle: 'Address users who want faster menus from small leftovers, especially solo cooks who do not want multiple dishes.',
    decision: 'Choose whether to wrap, top, or toast the ingredients, then use fast-cooking fillings with low moisture and a clear flavor direction.',
    patterns: [
    ...
    snapmeal: 'Snapmeal can help identify leftover ingredients that can be wrapped, topped, or toasted into a quick dinner with a matching flavor direction.',
  }),
  article({
    slug: 'frozen-food-dinner-upgrade',
    title: 'How to Upgrade Frozen Foods into a Real Dinner',
    description: 'Frozen dumplings, fried chicken, noodles, vegetables, and convenience-store frozen foods can become dinner when paired with eggs, rice, tofu, or vegetables.',
    jaHref: '/blog/frozen-food-dinner-upgrade/',
    date: 'May 25, 2026',
    category: 'Fridge Planning',
    image: '/blog/frozen-food-dinner-upgrade-thumbnail-1600x900.jpg',
    tags: ['Frozen food', 'Frozen vegetables', 'Dinner', 'Time saving'],
    intro: 'Frozen food becomes more satisfying when you treat it as one part of dinner instead of the whole meal, then add one missing role from the fridge.',
    angle: 'Reach busy solo cooks and households using supermarket or convenience-store frozen foods for practical weeknight meals.',
    decision: 'Assign the frozen food a role, then add what is missing: staple, protein, vegetable, or soup; one addition is usually enough on a tired day.',
    patterns: [
    ...
    snapmeal: 'Snapmeal can help combine frozen foods, convenience-store items, and fridge ingredients so dinner feels complete with little extra work.',
  }),
  article({
    slug: 'solo-cooking-tools',
    title: 'Time-Saving Cooking Tools for Solo Living',
    description: 'Solo cooking gets easier when you use a microwave, toaster oven, electric kettle, small pot, and frying pan for different jobs.',
    jaHref: '/blog/solo-cooking-tools/',
    date: 'May 25, 2026',
    category: 'Time Saving',
    image: '/blog/solo-cooking-tools-thumbnail-1600x900.jpg',
    tags: ['Solo living', 'Cooking tools', 'Time saving', 'Microwave cooking'],
    intro: 'For solo cooking, the best tool is the one that matches tonight’s energy, cleanup tolerance, ingredients, and the container you are willing to wash.',
    angle: 'Use the time-saving tools topic as a practical decision guide rather than a gadget shopping list.',
    decision: 'Use the microwave for reheating and prep, toaster for browning, kettle for hot water, small pot for soups and noodles, and frying pan for searing; small tools like heatproof containers and kitchen scissors also matter.',
    patterns: [
    ...
    snapmeal: 'Snapmeal can help choose meal ideas based on fridge ingredients, tonight’s energy level, and the cooking tool you want to use today.',
  }),
  article({
    slug: 'forgot-defrost-meat-dinner',
    title: 'Forgot to Defrost Meat? Dinner Ideas for Frozen or Half-Frozen Meat',
    description: 'When you forgot to defrost meat, choose soups, steam-fries, or backup proteins based on the type and thickness of the meat.',
    jaHref: '/blog/forgot-defrost-meat-dinner/',
    date: 'May 24, 2026',
    category: 'Time Saving',
    image: '/blog/forgot-defrost-meat-dinner-thumbnail-1600x900.jpg',
    tags: ['Frozen meat', 'Forgot to defrost', 'Dinner', 'Time saving'],
    intro: 'Forgetting to defrost meat does not have to stop dinner if you change the meal format to match the meat’s current state.',
    ...
    snapmeal: 'Snapmeal can help combine fridge ingredients and freezer stock into dinner ideas when the original plan falls apart.',
  }),
  article({
    slug: 'no-meat-fish-protein-dinner',
    title: 'No Meat or Fish for Dinner? Use Eggs, Tofu, Natto, and Cans',
    description: 'A meatless and fishless dinner can still feel complete when eggs, tofu, natto, canned tuna, or canned mackerel become the main protein.',
    jaHref: '/blog/no-meat-fish-protein-dinner/',
    date: 'May 24, 2026',
    category: 'Fridge Planning',
    image: '/blog/no-meat-fish-protein-dinner-thumbnail-1600x900.jpg',
    tags: ['No meat', 'No fish', 'Protein', 'Dinner'],
    intro: 'When there is no meat or fish in the fridge, the key is to promote small protein staples into the main part of dinner.',
    ...
    snapmeal: 'Snapmeal can help find protein options beyond meat and fish from the ingredients already at home.',
  }),
  article({
    slug: 'kids-lesson-day-dinner',
    title: 'Dinner on Kids’ Lesson Days: Plan Around Before and After',
    description: 'On activity or lesson days, dinner is easier when you decide whether the child eats lightly before leaving or quickly after coming home.',
    jaHref: '/blog/kids-lesson-day-dinner/',
    date: 'May 24, 2026',
    category: 'Family',
    image: '/blog/kids-lesson-day-dinner-thumbnail-1600x900.jpg',
    tags: ['Kids activities', 'Family dinner', 'Time saving', 'Dinner'],
    intro: 'Kids’ lesson days are hard because dinner is not only about the recipe. It is about timing.',
    ...
    snapmeal: 'Snapmeal can help choose meals that fit both the fridge contents and the family schedule.',
  }),
  article({
    slug: 'different-return-times-dinner',
    title: 'Family Members Coming Home at Different Times? Choose Reheatable Dinners',
    description: 'When family schedules do not match, choose dinners that reheat and portion easily instead of dishes that depend on being freshly cooked.',
    jaHref: '/blog/different-return-times-dinner/',
    date: 'May 24, 2026',
    category: 'Family',
    image: '/blog/different-return-times-dinner-thumbnail-1600x900.jpg',
    tags: ['Family', 'Different schedules', 'Dinner', 'Reheating'],
    intro: 'When everyone comes home at a different time, the best dinner is often the one that still works after reheating.',
    ...
    snapmeal: 'Snapmeal can help pick fridge-based dinners that match how your family will actually eat tonight.',
  }),
  article({
    slug: 'not-enough-vegetables-dinner',
    title: 'Not Enough Vegetables at Dinner? Add Them Without Making Extra Sides',
    description: 'When dinner lacks vegetables, add frozen vegetables, soup ingredients, or mixed-in vegetables instead of making another side dish.',
    jaHref: '/blog/not-enough-vegetables-dinner/',
    date: 'May 24, 2026',
    category: 'Meal Planning',
    image: '/blog/not-enough-vegetables-dinner-thumbnail-1600x900.jpg',
    tags: ['Vegetables', 'Frozen vegetables', 'Dinner', 'Healthy meals'],
    intro: 'Vegetables are easier to add when you put them into the meal you are already making instead of creating another dish.',
    ...
    snapmeal: 'Snapmeal can help identify small vegetables in the fridge that can be added to tonight’s meal.',
  }),
  article({
